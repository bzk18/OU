rm(list=ls())
library(MASS)
library(mvtnorm,lib.loc="/storage/home/bzk18/R/x86_64-redhat-linux-gnu-library/3.1")
library(matrixcalc,lib.loc="/storage/home/bzk18/R/x86_64-redhat-linux-gnu-library/3.1")
library(rlecuyer,lib.loc="/storage/home/bzk18/R/x86_64-redhat-linux-gnu-library/3.1")
library(parallel)
# library(CDROM)
...
get.spec.theta <- function(x,other.data){
...
Neochild.Sims <- clusterApply(cl,1:100, function(i){
  ...
  return(c("X"=x,"TPC"=TimePC,"TPCA"=TimePCA,"ThetaP"=Theta1,"ThetaC"=Theta2,"ThetaA"=Theta1,"Alpha"=Alpha,"Sigma2"=Sigma2,"loglikelihood"=neoc.logll))
})
...
Specialization.Sims <- clusterApply(cl,1:100, function(i){
  ...
  return(c("X"=x,"TPC"=TimePC,"TPCA"=TimePCA,"ThetaP"=Theta2,"ThetaC"=Theta3,"ThetaA"=Theta1,"Alpha"=Alpha,"Sigma2"=Sigma2,"loglikelihood"=spec.logll))
})
...
save(Pred.Class,Simulated.Models,Neochild.Model,Neoparent.Model,Cons.Model, Spec.Model,Sub.Model, file="Simulated_Models_Xall_v12_n2k.Rdata")
t2 <- Sys.time()
print(t2 - t1)
